    ...
    <form action="" id="client-form">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <textarea rows="3" name="address" id="address" class="form-control form-control-sm rounded-0" placeholder="Address" required><?php echo isset($address) ? $address : '' ?></textarea>
            </div>
        </div>
    </form>
</div>
